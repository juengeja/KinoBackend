...
public class SeatController {
    ...
    // Create a blank database of all the seats available
    public ArrayList<Integer> seatNumberCalculate()
    {
        ...
        // Zero is default value for the cbs
        al.add(0);

        // Calculate seatnumbers and add them into the array
        for (int i=0; i < 36; i++)
        {
            A = 101+i;
            al.add(A);
