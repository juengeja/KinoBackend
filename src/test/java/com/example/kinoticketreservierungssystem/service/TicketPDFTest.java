...
class TicketPDFTest {
    ...
    void createTicketPDF() {
        ...
        reservation = new Reservation("CreateTicketPDF-Reservationtest", seats, "Showevent-ID", "CreateTicketPDF-Bookingtest", 8, false );
        ...
        booking = new Booking("CreateTicketPDF-Bookingtest", customer, bookingTickets, "couponCode", "paymentMethod", 8, "reserved");
